...
ROOTFS_ISO9660_EFI_BOOT_MENU = $(call qstrip,$(BR2_TARGET_ROOTFS_ISO9660_EFI_BOOT_MENU))
ROOTFS_ISO9660_BOOTLOADER_CONFIG_PATHS = $(ROOTFS_ISO9660_BOOTLOADER_CONFIG_PATH)
...
ifeq ($(BR2_TARGET_ROOTFS_ISO9660_ISOLINUX)$(BR2_TARGET_ROOTFS_ISO9660_EFI_BOOTLOADER),yy)
ROOTFS_ISO9660_EFI_BOOTLOADER_CONFIG_PATH = \
	$(ROOTFS_ISO9660_EFI_PARTITION_CONTENT)/EFI/BOOT/grub.cfg
ROOTFS_ISO9660_EFI_BOOTLOADER_ISO_CONFIG_PATH = \
	$(ROOTFS_ISO9660_TMP_TARGET_DIR)/boot/grub/grub.cfg
ROOTFS_ISO9660_BOOTLOADER_CONFIG_PATHS += \
	$(ROOTFS_ISO9660_EFI_BOOTLOADER_CONFIG_PATH) \
	$(ROOTFS_ISO9660_EFI_BOOTLOADER_ISO_CONFIG_PATH)
define ROOTFS_ISO9660_INSTALL_EFI_BOOT_MENU
	$(INSTALL) -D -m 0644 $(ROOTFS_ISO9660_EFI_BOOT_MENU) \
		$(ROOTFS_ISO9660_EFI_BOOTLOADER_CONFIG_PATH)
	$(INSTALL) -D -m 0644 $(ROOTFS_ISO9660_EFI_BOOT_MENU) \
		$(ROOTFS_ISO9660_EFI_BOOTLOADER_ISO_CONFIG_PATH)
endef
...
define ROOTFS_ISO9660_PREPARATION
	$(INSTALL) -D -m 0644 $(ROOTFS_ISO9660_BOOT_MENU) \
		$(ROOTFS_ISO9660_BOOTLOADER_CONFIG_PATH)
	$(ROOTFS_ISO9660_INSTALL_EFI_BOOT_MENU)
...
define ROOTFS_ISO9660_DISABLE_EXTERNAL_INITRD
	$(SED) '/__INITRD_PATH__/d'  $(ROOTFS_ISO9660_BOOTLOADER_CONFIG_PATHS)
endef
...
ifeq ($(BR2_TARGET_ROOTFS_ISO9660_EFI_BOOTLOADER),y)
ROOTFS_ISO9660_PRE_GEN_HOOKS += ROOTFS_ISO9660_INSTALL_BOOTLOADER_EFI
endif
...
ROOTFS_ISO9660_ISOHYBRID_OPTS = -t 0x96
ifeq ($(BR2_TARGET_ROOTFS_ISO9660_EFI_BOOTLOADER),y)
ROOTFS_ISO9660_ISOHYBRID_OPTS += -u
endif

define ROOTFS_ISO9660_GEN_HYBRID
	$(HOST_DIR)/bin/isohybrid $(ROOTFS_ISO9660_ISOHYBRID_OPTS) $@
endef
